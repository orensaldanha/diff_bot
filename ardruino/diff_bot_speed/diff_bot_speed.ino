...
void messageCbSpeed( const std_msgs::UInt8& uint8_msg){
  analogWrite(ena, uint8_msg.data);
  analogWrite(enb, uint8_msg.data);
  nh.loginfo("Changing motor speed");
}

ros::Subscriber<std_msgs::UInt8> subspeed("speed", &messageCbSpeed );
